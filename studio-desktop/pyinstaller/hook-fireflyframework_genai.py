...
hiddenimports = [
    ...
    "fireflyframework_genai.studio.api.settings",
    "fireflyframework_genai.studio.api.evaluate",
    "fireflyframework_genai.studio.api.experiments",
    "fireflyframework_genai.studio.settings",
    "fireflyframework_genai.studio.evaluation",
