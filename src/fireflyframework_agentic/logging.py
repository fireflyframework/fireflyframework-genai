...
"""Logging utilities for the Firefly Agentic framework.

All framework modules log under the ``fireflyframework_agentic`` hierarchy.
...
Or even shorter::
    ...
    from fireflyframework_agentic.logging import enable_debug
...
_LOGGER_NAME = "fireflyframework_agentic"
...
def configure_logging(
    ...
    *,
    ...
    """Configure logging for all ``fireflyframework_agentic`` modules.
    ...
    The handler is added **only** to the ``fireflyframework_agentic`` logger,
