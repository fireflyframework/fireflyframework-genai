...
Python code using the Firefly Agentic Framework API.  Unlike the template-based
...
- Required pip packages (fireflyframework-agentic + any extras)
...
def create_smith_agent(user_name: str = "") -> FireflyAgent:
    ...
    from fireflyframework_agentic.studio.assistant.agent import _resolve_assistant_model
...
def _create_smith_tools() -> list:
    ...
    @firefly_tool(
        "get_framework_docs",
        description="Get live documentation about the Firefly Agentic Framework modules and capabilities.",
        auto_register=False,
    )
