...
def create_registry_tools() -> list[BaseTool]:
    ...
    @firefly_tool(
        "get_framework_docs",
        description=(
            "Get live documentation about the Firefly Agentic Framework. "
    ...
    async def get_framework_docs() -> str:
        ...
        for mod_name in [
            ...
            "fireflyframework_agentic.tools",
            "fireflyframework_agentic.reasoning",
            "fireflyframework_agentic.memory",
            "fireflyframework_agentic.pipeline",
            "fireflyframework_agentic.prompts",
            "fireflyframework_agentic.observability",
            "fireflyframework_agentic.security",
            "fireflyframework_agentic.content",
            "fireflyframework_agentic.experiments",
            "fireflyframework_agentic.explainability",
            "fireflyframework_agentic.exposure",
            "fireflyframework_agentic.lab",
            "fireflyframework_agentic.validation",
            "fireflyframework_agentic.resilience",
        ]:
            try:
        ...
        # Agent templates
        try:
            from fireflyframework_agentic.agents import agent_registry
        ...
        try:
            from fireflyframework_agentic.tools.registry import tool_registry as tr
        ...
        # Memory backends
        try:
            mod = importlib.import_module("fireflyframework_agentic.memory")
            classes = [
                name
        ...
        # Pipeline node types
        try:
            mod = importlib.import_module("fireflyframework_agentic.pipeline")
            classes = [
    ...
    async def get_tool_status() -> str:
        ...
        from fireflyframework_agentic.studio.settings import load_settings
        from fireflyframework_agentic.tools.registry import tool_registry
...
def create_custom_tool_tools() -> list[BaseTool]:
    ...
    async def create_custom_tool(
        ...
        from fireflyframework_agentic.studio.custom_tools import (
...
You have complete mastery of the Firefly Agentic Framework. This is your domain.
