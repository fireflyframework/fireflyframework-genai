...
def create_assistant_router() -> APIRouter:
    ...
    async def get_chat_history(project: str):
        from fireflyframework_agentic.studio.assistant.history import load_chat_history
    ...
    async def save_chat_history_endpoint(project: str, body: SaveHistoryRequest):
        from fireflyframework_agentic.studio.assistant.history import save_chat_history
    ...
    async def delete_chat_history(project: str):
        from fireflyframework_agentic.studio.assistant.history import clear_chat_history
