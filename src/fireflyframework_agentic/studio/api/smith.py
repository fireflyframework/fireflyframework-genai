...
def create_smith_router() -> APIRouter:
    ...
    async def get_smith_history(project: str):
        from fireflyframework_agentic.studio.assistant.history import load_smith_history
    ...
    async def save_smith_history_endpoint(project: str, body: _SaveHistoryBody):
        from fireflyframework_agentic.studio.assistant.history import save_smith_history
    ...
    async def delete_smith_history(project: str):
        from fireflyframework_agentic.studio.assistant.history import clear_smith_history
    ...
    async def get_smith_files(project: str):
        from fireflyframework_agentic.studio.assistant.history import load_smith_files
    ...
    async def save_smith_files_endpoint(project: str, body: _SaveFilesBody):
        from fireflyframework_agentic.studio.assistant.history import save_smith_files
...
async def _handle_generate(
    ...
    """
    try:
        from fireflyframework_agentic.studio.assistant.smith import (
        ...
        shared_context = ""
        try:
            from fireflyframework_agentic.studio.assistant.shared_context import (
...
async def _handle_chat(
    ...
    try:
        ...
        from fireflyframework_agentic.studio.settings import load_settings as _load_settings
...
async def _handle_sync_canvas(
    ...
    from fireflyframework_agentic.studio.assistant.smith import update_canvas_state
