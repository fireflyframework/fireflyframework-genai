...
def create_oracle_router() -> APIRouter:
    ...
    async def get_insights(project: str):
        from fireflyframework_agentic.studio.assistant.oracle_notifications import (
            list_insights,
        )
    ...
    async def get_oracle_chat_history(project: str):
        from fireflyframework_agentic.studio.assistant.history import load_oracle_history
    ...
    async def save_oracle_chat_history(project: str, body: _SaveChatHistoryBody):
        from fireflyframework_agentic.studio.assistant.history import save_oracle_history
    ...
    async def delete_oracle_chat_history(project: str):
        from fireflyframework_agentic.studio.assistant.history import clear_oracle_history
    ...
    async def oracle_ws(websocket: WebSocket, project: str = Query(default="")) -> None:
        ...
        try:
            from fireflyframework_agentic.studio.assistant.oracle import (
                create_oracle_agent,
            )
