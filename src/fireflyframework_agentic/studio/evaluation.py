...
Compiles a :class:`~fireflyframework_agentic.studio.codegen.models.GraphModel`,
...
async def run_evaluation(
    ...
    graph_data:
        ...
        :class:`~fireflyframework_agentic.studio.codegen.models.GraphModel`.
    cases:
    ...
    """
    from fireflyframework_agentic.studio.codegen.models import GraphModel
    from fireflyframework_agentic.studio.execution.compiler import CompilationError, compile_graph
