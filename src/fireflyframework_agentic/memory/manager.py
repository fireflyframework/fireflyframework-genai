...
class MemoryManager:
    ...
    def from_config(cls) -> MemoryManager:
        ...
        from :func:`~fireflyframework_agentic.config.get_config`.
        ...
        if cfg.memory_backend == "file":
            ...
            if cfg.memory_postgres_url is None:
                raise ValueError(
                    ...
                    "Set FIREFLY_AGENTIC_MEMORY_POSTGRES_URL environment variable."
                )
            ...
            if cfg.memory_mongodb_url is None:
                raise ValueError(
                    ...
                    "Set FIREFLY_AGENTIC_MEMORY_MONGODB_URL environment variable."
                )
