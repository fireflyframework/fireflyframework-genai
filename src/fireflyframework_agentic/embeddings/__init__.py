...
from fireflyframework_agentic.embeddings.base import BaseEmbedder, EmbeddingProtocol
...
from fireflyframework_agentic.embeddings.types import EmbeddingResult, EmbeddingUsage
